...
import 'package:campus_ride/Driver/Driver_signup.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class Driver_LoginScreen extends StatefulWidget {
  const Driver_LoginScreen({super.key});

  @override
  State<Driver_LoginScreen> createState() => _Driver_LoginScreenState();
}

class _Driver_LoginScreenState extends State<Driver_LoginScreen> {
  ...
  void _signup() {
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (_) => const Driver_SignupScreen()));
  }
